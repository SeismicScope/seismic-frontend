...
Core Colors serve as the design system's architectural foundation. These consist of static, raw palettes that remain constant across all themes and visual modes.
...
**Usage Note**: Directly applying Core Colors to components is discouraged. To ensure full theme support and architectural flexibility, always prioritize Theme or Mode tokens in your implementation.
